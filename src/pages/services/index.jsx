    ...
    <ul className="divide-y divide-gray-200">
              ...
              <div as="div" className="flex justify-between gap-x-6">
                ...
                <div className="flex flex-col items-end">
                  <div className="flex flex-raw gap-x-6 px-2">
                    <div>
                      <button type="button" className="flex gap-x-2" onClick={() => handleEdit(service.id)}>
                    ...
                    <div>
                      <button type="button" className="flex gap-x-2" onClick={() => handleView(service.id)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-600">
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
      ...
      <li className="py-4 px-2">
        <button type="button" className="flex gap-x-2" onClick={() => setOpenAdd(true)}>
          ...
          <span className="text-sm leading-4 text-gray-600">Añadir nuevo servicio</span>
        </button>
      </li>
