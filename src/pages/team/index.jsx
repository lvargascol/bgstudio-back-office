  ...
  return (
    <ul className="divide-y divide-gray-200">
      ...
      {specialists.map((specialist) => (
        <li key={`specialist-${specialist.id}`} className="py-2 px-2">
          <Disclosure as="div">
            {() => (
              <>
                <Disclosure.Button as="div" className="flex justify-between gap-x-6">
                  <div className="flex gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <p className="text-sm font-semibold leading-5 text-gray-900 py-0.5">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="flex flex-raw gap-x-6 px-2">
                      <div>
                        <button type="button" className="flex gap-x-2" onClick={() => handleEdit(specialist.id)}>
                      ...
                      <div>
                        <button type="button" className="flex gap-x-2" onClick={() => handleView(specialist.id)}>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-600">
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                ...
                <Disclosure.Panel className="flex justify-between">
                  <div className="flex gap-x-4">
                    <div className="min-w-0 flex-auto">
                      <p className="text-sm leading-5 text-gray-900">{specialist.position}</p>
