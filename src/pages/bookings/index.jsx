...
export default function Bookings() {
  ...
  // const dateNav = today === date ? ['Ayer', 'Hoy', 'Mañana'] : [moment(date).add(-1, 'days').format('DD-MM-YYYY'), moment(date).format('DD-MM-YYYY'), moment(date).add(1, 'days').format('DD-MM-YYYY')];
  return (
    <div>
